...
var db = PouchDB('http://server.pouchcloud.com/servers');
var xtend = require('xtend');
var marked = require('marked');
var domify = require('domify');

var md2html = R.compose(domify, marked);
...
var dispatch = require('./dispatcher')(state, update);

// stream sources
var pop$ = most.fromEvent('popstate', window).map(function (e) {
  return R.set(R.lensProp('popstate'), true, e);
});
var click$ = most.fromEvent('click', document);
var submit$ = most.fromEvent('submit', document);

var event$ = most.merge(click$, submit$, pop$);

var App = require('./components/app')(dispatch, event$);
...
},{"./components/app":2,"./dispatcher":9,"./qs":26,"domify":12,"marked":18,"xtend":23,"yo-yo":24}],2:[function(require,module,exports){
...
module.exports = function (dispatch, e$) {
  // eventless components
  var NavBar = require('./navbar');
  var List = require('./list');
  // components
  var Form = require('./form')(dispatch, e$);
  var Show = require('./show')(dispatch, e$);
  var Remove = require('./remove')(dispatch, e$);
  // router
  var Router = require('./router')(dispatch, e$);

  return function (state) {
    return yo(_templateObject, NavBar(state), Router(state, [{ '/': List }, { '/new': Form }, { '/edit': Form }, { '/show': Show }, { '/remove': Remove }]));
  };
};
},{"./form":3,"./list":4,"./navbar":5,"./remove":6,"./router":7,"./show":8,"yo-yo":24}],3:[function(require,module,exports){
var _templateObject = _taggedTemplateLiteral(['\n    <div class="form-group invisible">\n      <input type="hidden" name="type" value="Document">\n      <input type="hidden" name="_id" value="', '">\n      <input type="hidden" name="_rev" value="', '">\n    </div>\n  '], ['\n    <div class="form-group invisible">\n      <input type="hidden" name="type" value="Document">\n      <input type="hidden" name="_id" value="', '">\n      <input type="hidden" name="_rev" value="', '">\n    </div>\n  ']),
    _templateObject2 = _taggedTemplateLiteral(['\n    <section class="animated ', '">\n      <form id="server-form" class="m-t-1">\n        ', '\n        <div class="form-group">\n          <input type="text" class="form-control"\n            name="title" placeholder="Title"\n            value="', '"\n          >\n        </div>\n        <div class="form-group">\n          <textarea class="form-control" style="height: 300px"\n            name="description"\n            placeholder="Enter Document here...">', '</textarea>\n        </div>\n        <div class="form-group">\n          <button class="btn btn-primary-outline btn-block">Submit</button>\n        </div>\n        <div class="form-group">\n          <a class="btn btn-secondary-outline btn-block" href="/">Cancel</a>\n        </div>\n      </form>\n\n    </section>\n  '], ['\n    <section class="animated ', '">\n      <form id="server-form" class="m-t-1">\n        ', '\n        <div class="form-group">\n          <input type="text" class="form-control"\n            name="title" placeholder="Title"\n            value="', '"\n          >\n        </div>\n        <div class="form-group">\n          <textarea class="form-control" style="height: 300px"\n            name="description"\n            placeholder="Enter Document here...">', '</textarea>\n        </div>\n        <div class="form-group">\n          <button class="btn btn-primary-outline btn-block">Submit</button>\n        </div>\n        <div class="form-group">\n          <a class="btn btn-secondary-outline btn-block" href="/">Cancel</a>\n        </div>\n      </form>\n\n    </section>\n  ']);
...
var set = R.set;
var lensProp = R.lensProp;

module.exports = function (dispatch, e$) {
  e$.filter(function (e) {
    return e.target.id === 'server-form';
  }).tap(function (e) {
    return e.preventDefault();
  }).map(function (e) {
    return serialize(e.target, { hash: true });
  }).map(function (data) {
    return data._id ? data : set(lensProp('_id'), uuid.v4(), data);
  }).observe(function (doc) {
    return dispatch('/put', { doc: doc });
  });

  var hidden = function (doc) {
...
var _templateObject = _taggedTemplateLiteral(['\n<a class="list-group-item" href="/show?id=', '">\n  ', '\n</a>\n'], ['\n<a class="list-group-item" href="/show?id=', '">\n  ', '\n</a>\n']),
    _templateObject2 = _taggedTemplateLiteral(['<section class="animated ', '">\n  <div class="list-group m-t-1">\n    ', '\n  </div>\n</section>'], ['<section class="animated ', '">\n  <div class="list-group m-t-1">\n    ', '\n  </div>\n</section>']);
...
module.exports = function (state) {
  return yo(_templateObject2, state.leaving ? 'fadeOut' : 'fadeIn', state.docs ? state.docs.map(Item) : null);
};
},{"yo-yo":24}],5:[function(require,module,exports){
var _templateObject = _taggedTemplateLiteral(['\n  <nav class="navbar navbar-dark bg-primary">\n    <div class="container">\n      ', '\n\n      ', '\n\n      ', '\n      ', '\n      ', '\n\n      ', '\n\n      ', '\n    </div>\n  </nav>\n'], ['\n  <nav class="navbar navbar-dark bg-primary">\n    <div class="container">\n      ', '\n\n      ', '\n\n      ', '\n      ', '\n      ', '\n\n      ', '\n\n      ', '\n    </div>\n  </nav>\n']),
    _templateObject2 = _taggedTemplateLiteral(['\n      <a class="navbar-brand" href="#">\n        ', '\n      </a>'], ['\n      <a class="navbar-brand" href="#">\n        ', '\n      </a>']),
    _templateObject3 = _taggedTemplateLiteral(['\n      <a class="navbar-brand" href="#">\n        New Note\n      </a>'], ['\n      <a class="navbar-brand" href="#">\n        New Note\n      </a>']),
    _templateObject4 = _taggedTemplateLiteral(['<a class="navbar-brand" href="#">Edit Note</a>'], ['<a class="navbar-brand" href="#">Edit Note</a>']),
    _templateObject5 = _taggedTemplateLiteral(['<a class="navbar-brand" href="#">Remove Note</a>'], ['<a class="navbar-brand" href="#">Remove Note</a>']),
    _templateObject6 = _taggedTemplateLiteral(['\n        <a class="navbar-brand" href="/">\n          <i class="ion-chevron-left size-24"></i>\n          ', '\n        </a>'], ['\n        <a class="navbar-brand" href="/">\n          <i class="ion-chevron-left size-24"></i>\n          ', '\n        </a>']),
    _templateObject7 = _taggedTemplateLiteral(['\n      <ul class="nav navbar-nav pull-xs-right">\n        <li class="nav-item active">\n          <a class="nav-link" href="/new">new</a>\n        </li>\n      </ul>\n      '], ['\n      <ul class="nav navbar-nav pull-xs-right">\n        <li class="nav-item active">\n          <a class="nav-link" href="/new">new</a>\n        </li>\n      </ul>\n      ']),
    _templateObject8 = _taggedTemplateLiteral(['\n      <ul class="nav navbar-nav pull-xs-right">\n        <li class="nav-item active">\n          <a class="nav-link" href="/show?id=', '&menu=', '">edit</a>\n        </li>\n      </ul>\n      '], ['\n      <ul class="nav navbar-nav pull-xs-right">\n        <li class="nav-item active">\n          <a class="nav-link" href="/show?id=', '&menu=', '">edit</a>\n        </li>\n      </ul>\n      ']);
...
module.exports = function (dispatch, e$) {
  e$.filter(function (e) {
    return e.target.id === 'confirm';
  }).observe(function (_) {
    return dispatch('/remove', { confirm: true });
  });

  return function (state) {
    return yo(_templateObject, state.leaving ? 'zoomOut' : 'zoomIn', state.doc.server, state.doc._id);
  };
};
},{"yo-yo":24}],7:[function(require,module,exports){
/* global R */
...
module.exports = function (dispatch, e$) {
  ...
  return function (state, routes) {
    var fn = R.compose(R.prop(state.route), R.head, R.filter(function (route) {
...
module.exports = function (dispatch, e$) {
  ...
  e$.filter(function (e) {
    return e.target.id === 'remove-doc';
  }).observe(function (e) {
    return dispatch('/remove');
  });

  return function (state) {
    return yo(_templateObject, state.leaving ? 'fadeOut' : 'fadeIn', state.doc.html, state.showMenu ? 'animated slideInUp' : 'animated slideOutDown', state.doc._id);
  };
};
},{"yo-yo":24}],9:[function(require,module,exports){
var db = PouchDB('http://server.pouchcloud.com/servers');
var xtend = require('xtend');
var marked = require('marked');
var domify = require('domify');
...
var state = {};
module.exports = function (s, update) {
  state = xtend(state, s);

  var dispatch = function (route, params) {
...
},{"./qs":26,"domify":12,"marked":18,"xtend":23}],10:[function(require,module,exports){
...
},{"global/document":14,"hyperx":17,"on-load":20}],11:[function(require,module,exports){
...
},{"./update-events.js":25,"bel":10,"morphdom":19}],25:[function(require,module,exports){
module.exports = [
...
module.exports = R.compose(R.fromPairs, R.map(R.split('=')), R.split('&'), R.tail);
},{}]},{},[1]);
